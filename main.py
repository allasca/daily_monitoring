...
class MainApp(MDApp):
    ...
    def load_cfg(self, *args):
        ...
        # page 2
        form.vaksin1.text = cfg['form']['entry.1307812321_sentinel'] 
        form.vaksin2.text = cfg['form']['entry.140033922_sentinel'] 
        form.program_vaksin.text = cfg['form']['entry.709019755_sentinel'] 
        form.pergi_kerumunan.text = cfg['form']['entry.1602799393_sentinel'] 
        form.transportasi_umum.text = cfg['form']['entry.578814710_sentinel'] 
        form.zona_merah.text = cfg['form']['entry.283956020_sentinel'] 
        form.kegiatan_banyakorang.text = cfg['form']['entry.215556090_sentinel'] 
        form.kontak_covid.text = cfg['form']['entry.1518993024_sentinel']
        form.sesak_nafasbatuk.text = cfg['form']['entry.17751702_sentinel'] 
    ...
    def save_cfg(self):
        ...
        # page 2
        cfg['form']['entry.1307812321_sentinel'] = form.vaksin1.text
        cfg['form']['entry.140033922_sentinel'] = form.vaksin2.text
        cfg['form']['entry.709019755_sentinel'] = form.program_vaksin.text
        cfg['form']['entry.1602799393_sentinel'] = form.pergi_kerumunan.text
        cfg['form']['entry.578814710_sentinel'] = form.transportasi_umum.text
        cfg['form']['entry.283956020_sentinel'] = form.zona_merah.text
        cfg['form']['entry.215556090_sentinel'] = form.kegiatan_banyakorang.text
        cfg['form']['entry.1518993024_sentinel'] = form.kontak_covid.text
        cfg['form']['entry.17751702_sentinel'] = form.sesak_nafasbatuk.text
